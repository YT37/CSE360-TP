...
public class EmailAddressRecognizer {
	...
	public static String checkEmailAddress(String input) {
		...
		case 1:
			...
			emailAddressErrorMessage = "An email address must contain an '@' symbol.\n";
		...
		case 2:
			...
			emailAddressIndexofError = currentCharNdx;		
			emailAddressErrorMessage = "A domain name part must start with an alphanumeric character.\n";
			return emailAddressErrorMessage + displayInput(input, currentCharNdx);
		...
		case 4:
			...
			emailAddressIndexofError = currentCharNdx;		
			emailAddressErrorMessage = "A hyphen in a domain name must be followed by an alphanumeric character.\n";
			return emailAddressErrorMessage + displayInput(input, currentCharNdx);
