 ...
 * 
 * <p> Description: The Java/FX-based Contributor Home Page.  The page welcomes the user by name and
 * describes what the Contributor role will be able to do.  The widgets the user needs to play this role
...
public class ViewContributorHome {
	...
	protected static Label label_RoleDescription = new Label(
			"Contributors will be able to create and share content with the other members of the system.");
	...
	protected static final int theRole = 2;		// Admin: 1; Contributor: 2; Viewer: 3
	...
	private ViewContributorHome() {
		...
		// GUI Area 1
		label_PageTitle.setText("Contributor Home");
